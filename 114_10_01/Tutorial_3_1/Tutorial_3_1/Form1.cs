...
namespace Tutorial_3_1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void showDateButton_Click(object sender, EventArgs e)
        {
            ...
            // 組合顯示用的日期字串，格式為「中華民國{年}年{月}月{日}日，星期{星期幾}」
        ...
        {
            this.Close(); // 關閉表單，結束程式
        }

        private void clearButton_Click(object sender, EventArgs e)
        {
            dayOfWeekTextBox.Text = ""; // 清空星期幾的輸入框
            monthTextBox.Text = ""; // 清空月份的輸入框
            yearTextBox.Text = ""; // 清空年份的輸入框
            dayOfMonthTextBox.Text = ""; // 清空日期的輸入框
            dateOutputLabel.Text = ""; // 清空顯示日期的標籤
        }
    }
}
